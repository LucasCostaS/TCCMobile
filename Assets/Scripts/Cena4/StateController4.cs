...
public class StateController4 : MonoBehaviour
{
  ...
  private void ChecarReducao2Esquerda()
  {
    if (r[1] && reduzidos[4] && !reduzidos[1] && reduzir && estadoAtivo != Estado.Esquerda2 && !trava)
    {
      ...
      red2Esquerda.transform.GetChild(0).GetComponent<Resistores4>().SetResistencia(1 / ((1 / resistor[1].GetResistencia()) + (1 / red1.transform.GetChild(0).GetComponent<Resistores4>().GetResistencia())));
      r[1].SetActive(false);
  ...
  private void ChecarReducao2Direita()
  {
    if ((r[0] && r[3]) && (!reduzidos[0] || !reduzidos[3]) && reduzir && estadoAtivo != Estado.Direita2 && !trava)
    {
      ...
      // red2Direita.SetActive(true);
      red2Direita.transform.GetChild(0).GetComponent<Resistores4>().SetResistencia(1 / ((1 / resistor[0].GetResistencia()) + (1 / resistor[3].GetResistencia())));
      r[0].SetActive(false);
      r[3].SetActive(false);
  ...
  private void ChecarReducao3()
  {
    if (red2Esquerda.activeInHierarchy && red2Direita.activeInHierarchy && !trava && reduzir && estadoAtivo != Estado.Estado3)
    {
      ...
      red3.transform.GetChild(0).GetComponent<Resistores4>().SetResistencia(red2Direita.transform.GetChild(0).GetComponent<Resistores4>().GetResistencia() + red2Esquerda.transform.GetChild(0).GetComponent<Resistores4>().GetResistencia());
    }
  }
