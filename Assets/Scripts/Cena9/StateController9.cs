...
public class StateController9 : MonoBehaviour
{
  private enum Estado
  {
    Original,
  ...
  private Resistores9[] resistor = new Resistores9[5];
  ...
  private int checaPosicao(int i, Vector2[] sombras)
  {
    ...
    if (reduzidos[i] == false)
    {
      ...
      if (r[i] != null)
        resistor[i] = r[i].GetComponent<Resistores9>();
      else
        resistor[i] = null;
    }
  ...
  private void Animacao4()
  {
    ...
    if (res1.localRotation.z < res2.localRotation.z)
      res1.Rotate(0f, 0f, (90 / fps), Space.World);
    ...
    if (res1.localPosition.y >= res2.localPosition.y && res1.localPosition.x >= res2.localPosition.x && res1.localRotation.z >= res2.localRotation.z)
    {
      ...
      spawn = true;
      trava = false;
      if (Red[3].transform.GetChild(0).GetComponent<Resistores9>().GetResistencia() == 20m)
      {
  ...
  private void ChecarReducao2()
  {
    if (r[2] && !reduzidos[2] && reduzidos[1] && reduzir && estadoAtivo != Estado.Estado2 && !trava)
    {
      ...
      Red[1].transform.GetChild(0).GetComponent<Resistores9>().SetResistencia(Red[0].transform.GetChild(0).GetComponent<Resistores9>().GetResistencia() + resistor[2].GetResistencia());

      PreRed[PreRed.Count - 1].transform.GetChild(1).GetChild(0).GetComponent<Resistores9>().SetResistencia(Red[0].transform.GetChild(0).GetComponent<Resistores9>().GetResistencia());
    }
  }
  ...
  private void ChecarReducao1()
  {
    if (r[0] && r[1] && !reduzidos[0] && !reduzidos[1] && reduzir && estadoAtivo != Estado.Estado1 && !trava)
    {
      ...
      Red[0].transform.GetChild(0).GetComponent<Resistores9>().SetResistencia(1 / (1 / resistor[1].GetComponent<Resistores9>().GetResistencia() + 1 / resistor[0].GetResistencia()));
    }
  }
  ...
  private void ChecarReducao3()
  {
    if (r[3] && !reduzidos[3] && reduzidos[2] && reduzir && estadoAtivo != Estado.Estado3 && !trava)
    {
      ...
      Red[2].transform.GetChild(0).GetComponent<Resistores9>().SetResistencia(1 / (1 / Red[1].transform.GetChild(0).GetComponent<Resistores9>().GetResistencia() + 1 / resistor[3].GetResistencia()));

      PreRed[PreRed.Count - 1].transform.GetChild(2).GetChild(0).GetComponent<Resistores9>().SetResistencia(Red[1].transform.GetChild(0).GetComponent<Resistores9>().GetResistencia());
    }
  }
  ...
  private void ChecarReducao4()
  {
    if (r[4] && !reduzidos[4] && reduzidos[3] && reduzir && estadoAtivo != Estado.Estado4 && !trava)
    {
      ...
      Red[3].transform.GetChild(0).GetComponent<Resistores9>().SetResistencia(Red[2].transform.GetChild(0).GetComponent<Resistores9>().GetResistencia() + resistor[4].GetResistencia());

      PreRed[PreRed.Count - 1].transform.GetChild(3).GetChild(0).GetComponent<Resistores9>().SetResistencia(Red[2].transform.GetChild(0).GetComponent<Resistores9>().GetResistencia());
    }
  }
