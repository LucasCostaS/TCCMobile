...
public class EventoPC6 : MonoBehaviour
{
  ...
  private StateController6 state;
  ...
  private void OnEnable()
  {
    ...
    state = controller.GetComponent<StateController6>();
  ...
  private void OnMouseDrag()
  {
    ...
    {
      PegarPosicaoNoMundo();
      resistor.GetComponent<Resistores6>().SetPosicao(touchPosWorld + offset);
      state.reduzir = true;
  ...
  {
    GameObject sombra = resistor.GetComponent<Resistores6>().GetSombra();
  ...
  private void SpawnPeca()
  {
    if (state.spawn == true)
    {
      ...
      pecaCriada.GetComponent<Resistores6>().SetCriador(resistor);
